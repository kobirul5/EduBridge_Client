  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="container max-w-6xl mx-auto px-4 py-8 z-10">
        <div className="grid lg:grid-cols-2 gap-0 overflow-hidden bg-card/40 backdrop-blur-3xl border border-border/40 rounded-[40px] shadow-2xl shadow-primary/5 min-h-[650px]">
          ...
          <div className="flex flex-col justify-center p-8 lg:p-16 bg-card/10">
