...
export const confirmToast = ({
  ...
  toast.custom((t) => (
    <div className="relative flex w-full max-w-85 flex-col gap-4 overflow-hidden rounded-[1.8rem] border border-white/60 bg-white/90 p-5 shadow-[0_20px_50px_-12px_rgba(95,76,55,0.2)] backdrop-blur-xl animate-in fade-in zoom-in duration-300">
