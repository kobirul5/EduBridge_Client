...
EduBridge Frontend is the Next.js client for the EduBridge social platform. It handles the public site, authenticated social experience, admin dashboards, and all UI flows that talk to the backend API.
...
Most server actions and route handlers call the EduBridge backend with that base URL and the user token stored in cookies.

## Environment Variables

- `NEXT_PUBLIC_API_URL` - backend base URL, for example `https://EduBridge-server.onrender.com/api/v1`
